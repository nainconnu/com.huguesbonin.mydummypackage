...
<root>
  ...
  ├── Editor
  │   ├── Huguesbonin.Mydummypackage.Editor.asmdef
  │   └── EditorExample.cs
  ├── Runtime
  │   ├── Huguesbonin.Mydummypackage.asmdef
  │   └── RuntimeExample.cs
  ├── Tests
  │   ├── .tests.json
  │   ├── Editor
  │   │   ├── Huguesbonin.Mydummypackage.Editor.Tests.asmdef
  │   │   └── EditorExampleTest.cs
  │   └── Runtime
  │        ├── Huguesbonin.Mydummypackage.Tests.asmdef
...
1. Enter your package name. The name you choose should contain your default organization followed by the name you typed. For example: `Huguesbonin.Mydummypackage`.
...
To use the Inspector, select the `package.json` file in the Project browser. The **Package mydummypackage Manifest** page opens for editing.
...
* Store Editor-specific code under a root editor assembly definition file:
  ...
  `Editor/Huguesbonin.Mydummypackage.Editor.asmdef`

* Store runtime-specific code under a root runtime assembly definition file:

  `Runtime/Huguesbonin.Mydummypackage.asmdef`

* Configure related test assemblies for your editor and runtime scripts:

  `Tests/Editor/Huguesbonin.Mydummypackage.Editor.Tests.asmdef`

  `Tests/Runtime/Huguesbonin.Mydummypackage.Tests.asmdef`
...
Use the `Documentations~/mydummypackage.md` documentation file to create preliminary, high-level documentation. This document should introduce users to the features and sample files included in your package.  Your package documentation files will be used to generate online and local docs, available from the Package Manager UI.
